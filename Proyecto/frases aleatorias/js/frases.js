...
const frasesFrikisInformatica = [
    ...
    "Los bugs son como las malas hierbas: siempre aparecen cuando menos los esperas.",
     ...
     "La programación es como jugar con LEGO: construye cosas increíbles con pequeñas piezas.", 
     ...
     "La programación es como una de resistencia: te enfrentas a desafíos constantes para alcanzar tus objetivos.", 
     "Los buenos programadores no solo encuentran soluciones, ¡encuentran formas innovadoras de resolver problemas!", 
     "La programación es como un juego de construcción: ensamblas bloques de código para algo nuevo.", 
     ...
     "La creatividad es el combustible que alimenta la innovación en la programación: los programadores creativos ven los desafíos como oportunidades para pensar de manera diferentes y encontrar soluciones únicas que mejoren la vida de las personas.", 
...
function generarFraseAleatoria() {
    const fraseAleatoria = frasesFrikisInformatica[Math.floor(Math.random() * frasesFrikisInformatica.length)];
    phraseElement.textContent = fraseAleatoria;
}
...
moreContentButton.addEventListener("click", generarFraseAleatoria);
